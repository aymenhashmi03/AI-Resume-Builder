        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-2">
            <div className="flex items-center space-x-2 mb-4">
              <img src={aiLogo} alt="AI Logo" className="w-24 h-24 object-contain drop-shadow-lg filter brightness-110" />
              <span className="text-xl font-bold text-white">AI Resume Builder</span>
            </div>
            <p className="text-gray-400 mb-4 max-w-md">
              Get career tips and resume hacks straight to your inbox. Build your perfect resume with AI-powered tools.
            </p>
            {/* Newsletter */}
            <form className="flex flex-col sm:flex-row gap-2 max-w-md">
              <input
                ...
                className="flex-1 px-4 py-2 bg-navy-800 border border-navy-700 rounded-lg text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500"
                required
              />
              <button
                type="submit"
